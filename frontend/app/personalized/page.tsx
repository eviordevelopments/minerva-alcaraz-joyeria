      ...
      <div className="pt-32 md:pt-48 pb-32 luxury-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col gap-10">
            ...
            <h1 className="text-6xl md:text-8xl font-display text-verde-ebano leading-tight">Su Historia en Metales Preciosos</h1>
          ...
          <div className="bg-authority p-16 md:p-24 flex flex-col gap-12 shadow-2xl">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs md:text-sm uppercase tracking-widest opacity-60 text-hueso-seda">Inicie su ritual de personalización</p>
            </div>
            ...
            <form className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <textarea rows={5} className="bg-transparent border-b border-hueso-seda/40 py-3 text-base md:text-lg text-hueso-seda focus:outline-none focus:ring-0 focus:border-oro-antiguo transition-colors resize-none w-full" placeholder="Cuéntenos sobre la pieza que desea crear..." />
              </div>
              ...
              <p className="text-[10px] md:text-xs text-center opacity-40 uppercase tracking-[0.2em] mt-6 text-hueso-seda">
                Nuestro equipo le contactará en un máximo de 24 horas hábiles.
              </p>
            </form>
          </div>
