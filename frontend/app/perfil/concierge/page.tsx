          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="bg-verde-ebano p-10 flex flex-col gap-6 relative overflow-hidden">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-hueso-seda/60 text-base font-light leading-loose max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://wa.me/524626217960?text=Hola%20Minerva,%20soy%20miembro%20de%20The%20Circle..."
                  ...
                  className="flex items-center gap-3 bg-oro-antiguo text-verde-ebano text-xs uppercase tracking-[0.5em] px-8 py-4 hover:bg-hueso-seda transition-colors group"
                >
                ...
                <a href="mailto:concierge@minervaalcarazjoyeria.mx"
                  className="flex items-center gap-3 border border-hueso-seda/20 text-hueso-seda text-xs uppercase tracking-[0.4em] px-8 py-4 hover:border-oro-antiguo hover:text-oro-antiguo transition-colors"
                >
                  Enviar Correo
                </a>
              </div>
              <p className="text-[10px] uppercase tracking-[0.4em] text-hueso-seda/20">Respuesta garantizada en menos de 4 horas en días hábiles</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={s.title} className="bg-white border border-verde-ebano/8 p-6 flex flex-col gap-2">
                  <h3 className="text-[11px] uppercase tracking-[0.3em] text-verde-ebano font-medium">{s.title}</h3>
                  <p className="text-[11px] text-verde-ebano/35 leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
