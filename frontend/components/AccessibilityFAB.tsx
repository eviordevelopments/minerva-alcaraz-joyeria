...
export function AccessibilityFAB() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 left-6 z-[100000] w-12 h-12 rounded-full bg-[#2C3729] border border-[#CBB67B]/30 hidden md:flex items-center justify-center text-[#CBB67B] shadow-xl hover:shadow-[#CBB67B]/20 transition-all"
