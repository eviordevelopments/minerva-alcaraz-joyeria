      ...
      {isLowArousal && (
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link 
                href="/shop"
                onClick={handleDismiss}
                className="group flex items-center justify-center gap-3 px-8 py-4 border border-oro-antiguo text-oro-antiguo text-xs uppercase tracking-[0.3em] hover:bg-oro-antiguo hover:text-verde-ebano transition-all duration-500 w-full sm:w-auto"
              >
              ...
              <button 
                onClick={handleDismiss}
                className="group flex items-center justify-center gap-3 px-8 py-4 border border-hueso-seda/20 text-hueso-seda/70 text-xs uppercase tracking-[0.3em] hover:border-hueso-seda hover:text-hueso-seda transition-all duration-500 w-full sm:w-auto"
              >
                Continuar Navegando
                <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
              </button>
          ...
          <motion.div 
            ...
            className="absolute bottom-12 text-[10px] uppercase tracking-[0.4em] text-hueso-seda/20"
          >
