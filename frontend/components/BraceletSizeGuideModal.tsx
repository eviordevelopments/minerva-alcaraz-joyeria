...
export interface BraceletSizeGuideModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const BraceletSizeGuideModal: React.FC<BraceletSizeGuideModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <AnimatePresence>
    <div className="fixed inset-0 z-50 overflow-y-auto bg-[#2C3729]/80 backdrop-blur-md">
