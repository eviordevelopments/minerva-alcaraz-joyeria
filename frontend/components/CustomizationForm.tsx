    ...
    <section className="bg-authority p-12 md:p-20 shadow-2xl relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-12 relative z-10">
        <div className="flex flex-col gap-4 text-center">
          ...
          <p className="text-xs uppercase tracking-[0.4em] text-hueso-seda/60">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs uppercase tracking-widest text-oro-antiguo/50 flex items-center gap-2">
              <User size={12} /> Nombre
            </label>
            <input 
              type="text" 
              className="bg-transparent border-b border-hueso-seda/10 py-2 text-base text-hueso-seda focus:border-oro-antiguo outline-none transition-colors"
          ...
          <div className="md:col-span-2 flex flex-col gap-2">
            ...
            <textarea 
              rows={4}
              className="bg-hueso-seda/5 border border-hueso-seda/10 p-4 text-base text-hueso-seda focus:border-oro-antiguo outline-none transition-colors"
          ...
          <div className="flex flex-col gap-2">
            ...
            <select className="bg-transparent border-b border-hueso-seda/10 py-2 text-base text-hueso-seda focus:border-oro-antiguo outline-none transition-colors appearance-none">
        ...
        <p className="text-[10px] uppercase tracking-[0.3em] text-hueso-seda/30 text-center">
